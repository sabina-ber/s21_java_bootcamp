...
public class TransactionsService {
    ...
    public void executeTransaction(Integer recipientId, Integer senderId, Integer amount) {
        try {
            ...
            Transaction creditTransaction = new Transaction(recipient, sender, Transaction.TransferCategory.CREDIT, -amount, identifier);
    ...
    public Transaction removeTransactionById(User user, UUID id) throws TransactionNotFoundException {
        return user.getTransactionsList().removeTransactionById(id);
    }
